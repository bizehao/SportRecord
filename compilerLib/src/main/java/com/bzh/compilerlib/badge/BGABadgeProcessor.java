...
public class BGABadgeProcessor extends AbstractProcessor {
    private static final String CLASS_JAVA_DOC = "Generated by BGABadgView-Android. Do not edit it!\n";
    private static final String PACKAGE_NAME = "com.bzh.apilibrary.badge";
    ...
    private void generate(Set<String> viewClassSet) throws IllegalAccessException, IOException {
        ...
        for (String clazz : viewClassSet) {
            ...
            TypeSpec.Builder typeBuilder = TypeSpec.classBuilder(className)
                    ...
                    .addField(ClassName.get(PACKAGE_NAME, "String"), "test", Modifier.PRIVATE);
